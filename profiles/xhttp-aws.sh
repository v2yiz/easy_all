...
readonly XHTTP_AWS_PROFILE_ROOT="$(cd -- "$(dirname -- "${BASH_SOURCE[0]}")" >/dev/null 2>&1 && pwd)"
readonly XHTTP_PROFILE_ROOT="${XHTTP_AWS_PROFILE_ROOT}/../lib"
readonly XHTTP_PROFILE_FILE="${XHTTP_AWS_PROFILE_ROOT}/$(basename -- "${BASH_SOURCE[0]}")"
