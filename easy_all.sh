...
# Generic entrypoint for BWG/VM Reality or AnyTLS installations.
...
download_core() {
    ...
    CORE_FILE=$(mktemp "${TMPDIR:-/tmp}/easy-all-core.XXXXXX")
    CORE_IS_TEMP=1
...
download_core
export EASY_ALL_PROFILE=general
export EASY_ALL_ENTRY_SCRIPT="${SCRIPT_FILE}"
export EASY_ALL_ENTRY_COMMAND=easy_all
